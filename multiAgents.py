...
def betterEvaluationFunction(currentGameState: GameState):
    ...
    if n_dots > 0:
        score +=  1000 * 1.0/min(dots_distancia) # aumentar o score em 5pts para o dot mais pero
        score +=  1000 * 1.0/n_dots # aumentar o score inversamente em relacao ao numero de  dots no jogo
